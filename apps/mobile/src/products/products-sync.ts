...
type ServerProduct = { id: string; name: string; stock: number; price: string; category: string; kind: 'bahan_baku' | 'produk_jadi'; unit: string | null; recipeComplete: boolean; imageUrl: string | null; updatedAt: string };

...
const styles = StyleSheet.create({ list: { padding: 16, paddingBottom: 40 }, summary: { backgroundColor: colors.primary, padding: 20, borderRadius: 18, marginBottom: 12 }, summaryLabel: { color: '#CFE7E1', fontSize: 12 }, summaryValue: { color: '#FFF', fontSize: 28, fontWeight: '900', marginTop: 4 }, summarySub: { color: '#CFE7E1', marginTop: 5 }, empty: { color: colors.muted, textAlign: 'center', paddingVertical: 35 }, row: { backgroundColor: colors.surface, borderRadius: 14, padding: 14, marginBottom: 9, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, info: { flex: 1 }, name: { color: colors.ink, fontWeight: '800' }, meta: { color: colors.muted, fontSize: 10, marginTop: 4 }, right: { alignItems: 'flex-end', gap: 6 }, amount: { color: colors.ink, fontWeight: '900' }, badge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 999 }, synced: { backgroundColor: '#E7F6EC' }, pending: { backgroundColor: colors.orangeSoft }, badgeText: { fontSize: 9, fontWeight: '900' }, syncedText: { color: colors.green }, pendingText: { color: colors.orange } });

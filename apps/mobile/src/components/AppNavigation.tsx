...
const styles = StyleSheet.create({
  sidebar: { width: 210, backgroundColor: '#0D4F45', padding: 18 }, logo: { width: 42, height: 42, borderRadius: 13, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, logoText: { color: colors.primary, fontWeight: '900', fontSize: 21 }, partner: { marginTop: 20, paddingBottom: 18, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.15)' }, partnerName: { color: '#FFFFFF', fontWeight: '800' }, role: { color: '#A9D2C8', fontSize: 11, marginTop: 3 }, menu: { marginTop: 18, gap: 7, flex: 1 }, menuItem: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12, borderRadius: 11 }, activeMenu: { backgroundColor: 'rgba(255,255,255,0.14)' }, menuIcon: { color: '#A9D2C8', fontSize: 20, width: 23, textAlign: 'center' }, menuLabel: { color: '#CFE7E1', fontWeight: '700' }, activeMenuText: { color: '#FFFFFF' }, logout: { padding: 12 }, logoutText: { color: '#CFE7E1', fontWeight: '700' }, bottom: { height: 68, backgroundColor: colors.surface, borderTopWidth: 1, borderTopColor: colors.line, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }, bottomItem: { alignItems: 'center', gap: 3, minWidth: 58 }, bottomIcon: { color: colors.muted, fontSize: 19 }, bottomLabel: { color: colors.muted, fontSize: 10, fontWeight: '700' }, activeText: { color: colors.primary },
});
